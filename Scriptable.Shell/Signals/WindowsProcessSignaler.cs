...
namespace Scriptable.Shell.Signals {
    internal static class WindowsProcessSignaler {
        ...
        private static async Task<string> DeploySignalerExeAsync() {
            ...
            using (var fileStream = new FileStream(exePath, FileMode.CreateNew, FileAccess.Write, FileShare.None, Constants.ByteBufferSize, true)) {

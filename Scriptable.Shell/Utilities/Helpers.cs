...
namespace Scriptable.Shell.Utilities {
    ...
    internal static class Throw {
        ...
        public static void IfInvalidBuffer<T>(T[] buffer, int offset, int count) {
            ...
            if (offset + count > buffer.Length) throw new ArgumentOutOfRangeException("the segment described by offset and count must be within buffer");
        }
    ...
    internal static class Throw<TException>
        ...
        public static void If(bool condition, string message) {
            if (condition) throw Create(message);
        }

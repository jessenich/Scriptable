...
namespace Scriptable.Shell {
    ...
    public sealed class Shell {
        ...
        /// a <see cref="Scriptable.Shell.Command"/>
        /// </summary>
        public sealed class Options {
            ...
            /// <summary>
            /// Specifies a function which can modify the <see cref="Scriptable.Shell.Command"/>. Multiple such functions
            /// can be specified this way
            /// </summary>
            ...
            /// <summary>
            /// Specifies a function which can project the <see cref="Scriptable.Shell.Command"/> to a new <see cref="Scriptable.Shell.Command"/>.
            /// Intended to be used with <see cref="Scriptable.Shell.Command"/>-producing "pipe" functions like <see cref="Scriptable.Shell.Command.RedirectTo(System.Collections.Generic.ICollection{char})"/>
            /// </summary>
            ...
            /// <summary>
            /// Sets the initial working directory of the <see cref="Scriptable.Shell.Command"/> (defaults to the current working directory)
            /// </summary>.
            ...
            #if !NETSTANDARD1_3
            /// <summary>
            /// Adds or overwrites an environment variable to be passed to the <see cref="Scriptable.Shell.Command"/>
            /// </summary>
            ...
            /// <summary>
            /// Adds or overwrites a set of environmental variables to be passed to the <see cref="Scriptable.Shell.Command"/>
            /// </summary>
            ...
            /// <summary>
            /// If specified, a non-zero exit code will cause the <see cref="Scriptable.Shell.Command"/>'s <see cref="Task"/> to fail
            ...
            /// This means that there is no need to dispose of a <see cref="Scriptable.Shell.Command"/>.
            ///
            /// This also means that <see cref="Scriptable.Shell.Command.Process"/> cannot be reliably accessed,
            ...
            /// When a command is aborted, the underlying process will be killed as if using <see cref="Scriptable.Shell.Command.Kill"/>
            /// </summary>

...
namespace Scriptable {
    /// <summary>
    /// Represents a "signal" that can be sent to a <see cref="ShellCommand"/>
    /// </summary>
    public sealed class CommandSignal {
        ...
        /// <summary>
        /// The input interrupt signal (CTRL_C_EVENT on Windows, SIGINT on Unix).
        ///
        ...
        public static CommandSignal ControlC { get; } =
            ...
            new(PlatformCompatibilityHelper.IsWindows ? (int)NativeMethods.CtrlType.CtrlCEvent : 2);
        ...
        /// </summary>
        public static CommandSignal FromSystemValue(int signal) {
            return new(signal);
        }
    }
}

...
namespace Scriptable {
    ...
    /// </summary>
    public abstract class ShellCommand : IDisposable, IShellCommand {
        // prevent external inheritors
        internal ShellCommand() { }

        /// <summary>
        /// The <see cref="System.Diagnostics.Process"/> associated with this <see cref="ShellCommand"/>. In a multi-process command,
        /// this will be the final <see cref="System.Diagnostics.Process"/> in the chain. NOTE: this property cannot be accessed when using
        /// the <see cref="Shell.ShellOptions.DisposeOnExit(bool)"/> option
        /// </summary>
        public abstract Process Process { get; }

        /// <summary>
        /// All <see cref="System.Diagnostics.Process"/>es associated with this <see cref="ShellCommand"/>. NOTE: this property cannot be accessed when using
        /// the <see cref="Shell.ShellOptions.DisposeOnExit(bool)"/> option
        /// </summary>
        public abstract IReadOnlyList<Process> Processes { get; }

        /// <summary>
        /// The PID of the process associated with this <see cref="ShellCommand"/>. In a multi-process command,
        /// this will be the PID of the final <see cref="System.Diagnostics.Process"/> in the chain. NOTE: unlike
        /// the <see cref="Process"/> property, this property is compatible with the <see cref="Shell.ShellOptions.DisposeOnExit(bool)"/>
        /// option
        /// </summary>
        public abstract int ProcessId { get; }

        /// <summary>
        /// All PIDs of the <see cref="System.Diagnostics.Process"/>es associated with this <see cref="ShellCommand"/>. NOTE: unlike
        /// the <see cref="Processes"/> property, this property is compatible with the
        /// <see cref="Shell.ShellOptions.DisposeOnExit(bool)"/> option
        /// </summary>
        ...
        /// underlying the current <see cref="ShellCommand"/>. Returns true if at least one <see cref="System.Diagnostics.Process"/>
        ...
        /// <summary>
        /// A <see cref="Task"/> representing the progress of this <see cref="ShellCommand"/>
        /// </summary>
        ...
        /// <summary>
        /// Implements <see cref="ShellCommand"/> piping as in bash. The first <see cref="ShellCommand"/>'s standard output is piped
        /// to the second's standard input. Returns a new <see cref="ShellCommand"/> instance whose <see cref="ShellCommand.Task"/> tracks
        /// the progress of the entire chain
        /// </summary>
        public ShellCommand PipeTo(ShellCommand second) {
        ...
        /// <summary>
        /// Standard output redirection as in bash. The <see cref="ShellCommand"/>'s standard output is written to the given
        /// <paramref name="stream"/>. Returns a new <see cref="ShellCommand"/> whose <see cref="ShellCommand.Task"/> tracks the progress
        /// of both this <see cref="ShellCommand"/> and the IO being performed
        /// </summary>
        public ShellCommand RedirectTo(Stream stream) {
        ...
        /// <summary>
        /// Standard error redirection as in bash. The <see cref="ShellCommand"/>'s standard error is written to the given
        /// <paramref name="stream"/>. Returns a new <see cref="ShellCommand"/> whose <see cref="ShellCommand.Task"/> tracks the progress
        /// of both this <see cref="ShellCommand"/> and the IO being performed
        /// </summary>
        public ShellCommand RedirectStandardErrorTo(Stream stream) {
            Throw.IfNull(stream, nameof(stream));
        ...
        /// <summary>
        /// Standard input redirection as in bash. The given <paramref name="stream"/> is written to the <see cref="ShellCommand"/>'s
        /// standard output. Returns a new <see cref="ShellCommand"/> whose <see cref="ShellCommand.Task"/> tracks the progress
        /// of both this <see cref="ShellCommand"/> and the IO being performed
        /// </summary>
        public ShellCommand RedirectFrom(Stream stream) {
            Throw.IfNull(stream, nameof(stream));
        ...
        /// <summary>
        /// Standard output redirection as in bash. The <see cref="ShellCommand"/>'s standard output is written to the given
        /// <paramref name="file"/>. Returns a new <see cref="ShellCommand"/> whose <see cref="ShellCommand.Task"/> tracks the progress
        /// of both this <see cref="ShellCommand"/> and the IO being performed
        /// </summary>
        public ShellCommand RedirectTo(FileInfo file) {
        ...
        /// of both this <see cref="ShellCommand"/> and the IO being performed
        /// </summary>
        public ShellCommand RedirectStandardErrorTo(FileInfo file) {
            Throw.IfNull(file, nameof(file));
        ...
        /// <summary>
        /// Standard input redirection as in bash. The given <paramref name="file"/> is written to the <see cref="ShellCommand"/>'s
        /// standard output. Returns a new <see cref="ShellCommand"/> whose <see cref="ShellCommand.Task"/> tracks the progress
        /// of both this <see cref="ShellCommand"/> and the IO being performed
        /// </summary>
        public ShellCommand RedirectFrom(FileInfo file) {
            Throw.IfNull(file, nameof(file));
        ...
        /// <summary>
        /// Standard output redirection as in bash. The lines of <see cref="ShellCommand"/>'s standard output are added to the given
        /// collection (<paramref name="lines"/> Returns a new <see cref="ShellCommand"/>  whose <see cref="ShellCommand.Task"/> tracks
        /// the progress of both this <see cref="ShellCommand"/> and the IO being performed
        /// </summary>
        public ShellCommand RedirectTo(ICollection<string> lines) {
        ...
        /// <summary>
        /// Standard error redirection as in bash. The lines of <see cref="ShellCommand"/>'s standard error are added to the given
        /// collection (<paramref name="lines"/> Returns a new <see cref="ShellCommand"/>  whose <see cref="ShellCommand.Task"/> tracks
        /// the progress of both this <see cref="ShellCommand"/> and the IO being performed
        /// </summary>
        public ShellCommand RedirectStandardErrorTo(ICollection<string> lines) {
            Throw.IfNull(lines, nameof(lines));
        ...
        /// <summary>
        /// Standard input redirection as in bash. The items in <paramref name="lines"/> are written to the <see cref="ShellCommand"/>'s
        /// standard output as lines of text. Returns a new <see cref="ShellCommand"/> whose <see cref="ShellCommand.Task"/> tracks the
        /// progress of both this <see cref="ShellCommand"/> and the IO being performed
        /// </summary>
        public ShellCommand RedirectFrom(IEnumerable<string> lines) {
            Throw.IfNull(lines, nameof(lines));
        ...
        /// <summary>
        /// Standard output redirection as in bash. The chars of <see cref="ShellCommand"/>'s standard output are added to the given
        /// collection (<paramref name="chars"/> Returns a new <see cref="ShellCommand"/> whose <see cref="ShellCommand.Task"/> tracks
        /// the progress of both this <see cref="ShellCommand"/> and the IO being performed
        /// </summary>
        public ShellCommand RedirectTo(ICollection<char> chars) {
        ...
        /// <summary>
        /// Standard error redirection as in bash. The chars of <see cref="ShellCommand"/>'s standard error are added to the given
        /// collection (<paramref name="chars"/> Returns a new <see cref="ShellCommand"/> whose <see cref="ShellCommand.Task"/> tracks
        /// the progress of both this <see cref="ShellCommand"/> and the IO being performed
        /// </summary>
        public ShellCommand RedirectStandardErrorTo(ICollection<char> chars) {
            Throw.IfNull(chars, nameof(chars));
        ...
        /// <summary>
        /// Standard input redirection as in bash. The items in <paramref name="chars"/> are written to the <see cref="ShellCommand"/>'s
        /// standard output. Returns a new <see cref="ShellCommand"/> whose <see cref="ShellCommand.Task"/> tracks the
        /// progress of both this <see cref="ShellCommand"/> and the IO being performed
        /// </summary>
        public ShellCommand RedirectFrom(IEnumerable<char> chars) {
            Throw.IfNull(chars, nameof(chars));
        ...
        /// <summary>
        /// Standard output redirection as in bash. The <see cref="ShellCommand"/>'s standard output is written to the given
        /// <paramref name="writer"/>. Returns a new <see cref="ShellCommand"/> whose <see cref="ShellCommand.Task"/> tracks the progress
        /// of both this <see cref="ShellCommand"/> and the IO being performed
        /// </summary>
        public ShellCommand RedirectTo(TextWriter writer) {
        ...
        /// of both this <see cref="ShellCommand"/> and the IO being performed
        /// </summary>
        public ShellCommand RedirectStandardErrorTo(TextWriter writer) {
            Throw.IfNull(writer, nameof(writer));
        ...
        /// <summary>
        /// Standard input redirection as in bash. The given <paramref name="reader"/> is written to the <see cref="ShellCommand"/>'s
        /// standard output. Returns a new <see cref="ShellCommand"/> whose <see cref="ShellCommand.Task"/> tracks the progress
        /// of both this <see cref="ShellCommand"/> and the IO being performed
        /// </summary>
        public ShellCommand RedirectFrom(TextReader reader) {
        ...
        public IEnumerable<string> GetOutputAndErrorLines() {
            return new MergedLinesEnumerable(this.StandardOutput, this.StandardError);
        }
        ...
        /// the progress of the entire chain
        /// </summary>
        public static ShellCommand operator |(ShellCommand first, ShellCommand second) {
        ...
        /// of both this <see cref="ShellCommand"/> and the IO being performed
        /// </summary>
        public static ShellCommand operator >(ShellCommand command, Stream stream) {
        ...
        /// of both this <see cref="ShellCommand"/> and the IO being performed
        /// </summary>
        public static ShellCommand operator >(ShellCommand command, FileInfo file) {
            Throw.IfNull(command, "command");
        ...
        /// type is to provide the required parity with the input redirection operator. Returns a new <see cref="ShellCommand"/>
        /// whose <see cref="ShellCommand.Task"/> tracks the progress of both this <see cref="ShellCommand"/> and the IO being performed
        /// </summary>
        public static ShellCommand operator >(ShellCommand command, IEnumerable<string> lines) {
        ...
        /// whose <see cref="ShellCommand.Task"/> tracks the progress of both this <see cref="ShellCommand"/> and the IO being performed
        /// </summary>
        public static ShellCommand operator >(ShellCommand command, IEnumerable<char> chars) {
            Throw.IfNull(command, nameof(command));
            Throw.IfNull(chars, nameof(chars));
        ...
        /// <summary>
        /// A convenience method for calling <see cref="Shell.Run(string, IEnumerable{object}, Action{Shell.ShellOptions})"/> on <see cref="Shell.Default"/>
        /// </summary>
        public static ShellCommand Run(string executable, IEnumerable<object>? arguments = null, Action<Shell.ShellOptions>? options = null) {
            return Shell.Default.Run(executable, arguments, options);
        }

        /// <summary>
        /// A convenience method for calling <see cref="Shell.TryAttachToProcess(int,System.Action{Scriptable.Shell.ShellOptions}?,out Scriptable.ShellCommand?)"/> on <see cref="Shell.Default"/>
        /// </summary>
        public static bool TryAttachToProcess(int processId, Action<Shell.ShellOptions> options, [NotNullWhen(true)] out ShellCommand? attachedCommand) {
            return Shell.Default.TryAttachToProcess(processId, options, out attachedCommand);
        }

        /// <summary>
        /// A convenience method for calling <see cref="Shell.TryAttachToProcess(int,out Scriptable.ShellCommand?)"/> on <see cref="Shell.Default"/>
        /// </summary>
        public static bool TryAttachToProcess(int processId, [NotNullWhen(true)] out ShellCommand? attachedCommand) {
        ...
        /// </summary>
        public static ShellCommand Run(string executable, params object[] arguments) {
        ...
        /// <summary>
        /// Throws <see cref="ObjectDisposedException"/> if the <see cref="ShellCommand"/> has been disposed
        /// </summary>

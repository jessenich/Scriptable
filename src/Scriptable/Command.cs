...
namespace Scriptable {
    ...
    public abstract class Command : IDisposable {
        ...
        /// <summary>
        /// A convenience method for calling <see cref="Shell.TryAttachToProcess(int,System.Action{Scriptable.Shell.Options}?,out Scriptable.Command?)"/> on <see cref="Shell.Default"/>
        /// </summary>
        ...
        /// <summary>
        /// A convenience method for calling <see cref="Shell.TryAttachToProcess(int,out Scriptable.Command?)"/> on <see cref="Shell.Default"/>
        /// </summary>
